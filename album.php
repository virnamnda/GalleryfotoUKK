                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="update_album.php" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" name="namaalbum" class="form-control" value="<?= $data['namaalbum'] ?>" autocomplete="off">
                                                <label class="form-label">deskripsi</label>
                                                <input type="text" name="deskripsi" class="form-control" value="<?= $data['deskripsi'] ?>" autocomplete="off">
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="tambah_album.php" method="post">
                    <div class="modal-body">
                        <label class="form-label">nama album</label>
                        <input type="text" name="namaalbum" class="form-control" required autocomplete="off">
                        <label class="form-label">deskripsi</label>
